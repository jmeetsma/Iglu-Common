...
public class ExtendedClassPathClassLoaderTest {
	...
	public void testClassLoaderInAction() throws Exception {
		...
		Object helper = ReflectionSupport.instantiateClass(classLoader, "org.ijsberg.iglu.runtime.classloading.ExtendedClassPathClassLoaderTestHelper", tmpDir);
	...
	public void testGetResource() throws Exception {
		URL url = this.getClass().getClassLoader().getResource("org/ijsberg/iglu/runtime/classloading/test.properties");
	...
	public void testGetResourceBundle() throws Exception {
		...
		Object helper = ReflectionSupport.instantiateClass("org.ijsberg.iglu.runtime.classloading.ExtendedClassPathClassLoaderTestHelper", tmpDir);
		ReflectionSupport.invokeMethod(helper, "testGetResourceBundleFail");

		ExtendedClassPathClassLoader classLoader = new ExtendedClassPathClassLoader(tmpDir.getAbsolutePath() + "/jars;" + tmpDir.getAbsolutePath() + "/classes");
		helper = ReflectionSupport.instantiateClass(classLoader, "org.ijsberg.iglu.runtime.classloading.ExtendedClassPathClassLoaderTestHelper", tmpDir);
